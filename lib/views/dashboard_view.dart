...
class _TopBarState extends State<_TopBar> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          // Hamburger menu button - show on mobile or when showHamburger is true (web)
          ...
          if (widget.activeTab == DashboardTab.tasks) ...[
            ...
            ShadButton(
              ...
              size: widget.isMobile ? ShadButtonSize.sm : ShadButtonSize.md,
              icon: const Icon(Icons.add, size: 20),
              child: widget.isMobile ? const SizedBox.shrink() : const Text('Add Task'),
            ),
          ],
        ],
      ),
